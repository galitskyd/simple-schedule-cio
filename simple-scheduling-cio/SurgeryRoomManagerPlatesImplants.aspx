...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>Plates and Implants Manager</title>
    ...
    <body>
        ...
        <div>
            ...
            <div id="login-box" class="login-popup">
            	    ...
            	    PlatesImplants:<label class="lblPlatesImplants" style="position:relative;left:30px;"> <asp:TextBox  runat="server" ID="txtPlatesImplants" CssClass="inputs"></asp:TextBox></label><br />
                    <asp:Button ID="btnAddItem" class="submit button" runat="server" Text="Add Item" OnClick="btnAddItem_Click"></asp:Button>
		    </div>
            <asp:Button ID="btnAdd" CssClass="add-window" runat="server" Text="Add Plate/Implant" OnClientClick="addPopup();return false;"/>
            <asp:Button ID="btnToggle" runat="server" Text="Toggle Plates/Implants" OnClick="btnToggle_Click" />
            <asp:Button ID="btnRemove" runat="server" Text="Delete Plates/Implants" OnClick="btnDelete_Click" />
        </div>
        </form>
    </body>
</html>
