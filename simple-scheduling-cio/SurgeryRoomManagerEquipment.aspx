    ...
    <body>
        ...
        <div>
            ...
            <div id="login-box" class="login-popup">
            	    ...
            	    Equipment:<label class="lblEquipment" style="position:relative;left:30px;"> <asp:TextBox  runat="server" ID="txtEquipment" CssClass="inputs"></asp:TextBox></label><br />
                    <asp:Button ID="btnAddItem" class="submit button" runat="server" Text="Add Item" OnClick="btnAddItem_Click"></asp:Button>
		    </div>
            <asp:Button ID="btnAdd" CssClass="add-window" runat="server" Text="Add Equipment" OnClientClick="addPopup();return false;"/>
            <asp:Button ID="btnToggle" runat="server" Text="Toggle Equipment" OnClick="btnToggle_Click" />
            <asp:Button ID="btnRemove" runat="server" Text="Delete Equipment" OnClick="btnDelete_Click" />
        </div>
        </form>
    </body>
</html>
