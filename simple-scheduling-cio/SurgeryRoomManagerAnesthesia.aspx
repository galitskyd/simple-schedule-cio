...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>SurgeryGenie - Anesthesia Manager</title>
    ...
    <body style="background-color: #F0F1F1">
        ...
        <form id="form1" runat="server">
            <div class="container-fluid">
                ...
                <div class="row management-content" style="padding-top: 0;">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="row">
                            <div class="col-lg-4">
                                <a id="btnAdd" class="btn btn-primary btn-lg btn-full" runat="server" onclick="$('#add-anesthesia').modal();">Add Anesthesia</a>
                            </div>
                            <div class="col-lg-4">
                                <asp:Button ID="btnToggle" CssClass="btn btn-primary btn-lg btn-full" runat="server" Text="Toggle Anesthesia" OnClick="btnToggle_Click" />
                            </div>
                            <div class="col-lg-4">
                                <asp:Button ID="btnRemove" CssClass="btn btn-danger btn-lg btn-full" runat="server" Text="Delete Anesthesia" OnClick="btnDelete_Click" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="add-anesthesia" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
